...
import com.batch.health.pass.PassEntity;
import com.batch.health.pass.PassRepository;
import com.batch.health.pass.PassStatus;
...
@SpringBootTest
@ActiveProfiles("test")
@ContextConfiguration(classes = {ExpirePassesJobConfigTest.class, HealthTest.class})
